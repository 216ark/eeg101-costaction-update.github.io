...
If you are interested in EEG, please [join](/join) our network.

## Get in Touch

For up-to-date administrative information, please check the description of the project on the [COST Action website](https://www.cost.eu/actions/CA24148).

<div class="wide-card">
  <h3>Action Chair</h3>
  {% include person id="faisal" email="yes" photo="no" affiliation="no" %}
</div>

<div class="wide-card">
  <h3>Vice Chair</h3>
  {% include person id="anneso" photo="no" affiliation="no"  %}
</div>

## Mailing Address

EEG101 COST Action  
c/o Prof. Faisal Mushtaq  
